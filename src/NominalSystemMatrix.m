function [IM_nom, f_nom, Controls] = NominalSystemMatrix(q_Nom, Controls, ElastoDyn, Airfoils, Twr, Bld, Platform, WindNom, mooring_load, f_Morison, F_Fairleads)
%#Codegen
g = 9.80665;
% Dofs
q_Sg   = q_Nom(1);
...
[Z, A, D, C, E, J1, J2, J3,  ~, ~, ~, MB1, MB2, MB3,...
    BP1, BP2, BP3, TP1, TP2, TP3, rP1, rP2, rP3, rP1_tip, rP2_tip, rP3_tip] = Coordinate_systems(q_Nom, BlPitch, ElastoDyn, Twr, Bld, Platform);
%% Position vectors
% Position Vectors
...
Ew_rel1_tip_y = -(Platform.dO1_V*qd_P1V1 + Platform.dO2_V*qd_P1V2);
Ew_rel1_tip_z =   Platform.dO1_H*qd_P1H1 + Platform.dO2_H*qd_P1H2;
EwP1_tip = EwX + Ew_rel1_tip_y*BP1(2,:) + Ew_rel1_tip_z*BP1(3,:);

Ew_rel2_tip_y = -(Platform.dO1_V*qd_P2V1 + Platform.dO2_V*qd_P2V2);
Ew_rel2_tip_z =   Platform.dO1_H*qd_P2H1 + Platform.dO2_H*qd_P2H2;
EwP2_tip = EwX + Ew_rel2_tip_y*BP2(2,:) + Ew_rel2_tip_z*BP2(3,:);

Ew_rel3_tip_y = -(Platform.dO1_V*qd_P3V1 + Platform.dO2_V*qd_P3V2);
Ew_rel3_tip_z =   Platform.dO1_H*qd_P3H1 + Platform.dO2_H*qd_P3H2;
EwP3_tip = EwX + Ew_rel3_tip_y*BP3(2,:) + Ew_rel3_tip_z*BP3(3,:);
...
XvP1_1 = -(Platform.s11_V*q_P1V1*qd_P1V1 + Platform.s22_V*q_P1V2*qd_P1V2 + Platform.s12_V*(q_P1V1*qd_P1V2 + q_P1V2*qd_P1V1) ...
         + Platform.s11_H*q_P1H1*qd_P1H1 + Platform.s22_H*q_P1H2*qd_P1H2 + Platform.s12_H*(q_P1H1*qd_P1H2 + q_P1H2*qd_P1H1));
XvP1_2 = Platform.O1_H*qd_P1H1 + Platform.O2_H*qd_P1H2;
XvP1_3 = Platform.O1_V*qd_P1V1 + Platform.O2_V*qd_P1V2;
XvP1   = coprod(XvP1_1, BP1(1,:)) + coprod(XvP1_2, BP1(2,:)) + coprod(XvP1_3, BP1(3,:));
% 分布节点绝对速度
EvP1   = repmat(EvZ, 1, 1, Platform.nt) + XvP1 + cross(repmat(EwX, 1, 1, Platform.nt), rP1, 2);

% 端部集中质量相对速度
XvP1_tip_1 = -(Platform.S11_V*q_P1V1*qd_P1V1 + Platform.S22_V*q_P1V2*qd_P1V2 + Platform.S12_V*(q_P1V1*qd_P1V2 + q_P1V2*qd_P1V1) ...
             + Platform.S11_H*q_P1H1*qd_P1H1 + Platform.S22_H*q_P1H2*qd_P1H2 + Platform.S12_H*(q_P1H1*qd_P1H2 + q_P1H2*qd_P1H1));
XvP1_tip_2 = O1_H_tip*qd_P1H1 + O2_H_tip*qd_P1H2;
XvP1_tip_3 = O1_V_tip*qd_P1V1 + O2_V_tip*qd_P1V2;
XvP1_tip   = XvP1_tip_1*BP1(1,:) + XvP1_tip_2*BP1(2,:) + XvP1_tip_3*BP1(3,:);
% 端部绝对速度
EvP1_tip   = EvZ + XvP1_tip + cross(EwX, rP1_tip);

% --- 梁 2 (指向 120 度) ---
XvP2_1 = -(Platform.s11_V*q_P2V1*qd_P2V1 + Platform.s22_V*q_P2V2*qd_P2V2 + Platform.s12_V*(q_P2V1*qd_P2V2 + q_P2V2*qd_P2V1) ...
         + Platform.s11_H*q_P2H1*qd_P2H1 + Platform.s22_H*q_P2H2*qd_P2H2 + Platform.s12_H*(q_P2H1*qd_P2H2 + q_P2H2*qd_P2H1));
XvP2_2 = Platform.O1_H*qd_P2H1 + Platform.O2_H*qd_P2H2;
XvP2_3 = Platform.O1_V*qd_P2V1 + Platform.O2_V*qd_P2V2;
XvP2   = coprod(XvP2_1, BP2(1,:)) + coprod(XvP2_2, BP2(2,:)) + coprod(XvP2_3, BP2(3,:));
EvP2   = repmat(EvZ, 1, 1, Platform.nt) + XvP2 + cross(repmat(EwX, 1, 1, Platform.nt), rP2, 2);

XvP2_tip_1 = -(Platform.S11_V*q_P2V1*qd_P2V1 + Platform.S22_V*q_P2V2*qd_P2V2 + Platform.S12_V*(q_P2V1*qd_P2V2 + q_P2V2*qd_P2V1) ...
             + Platform.S11_H*q_P2H1*qd_P2H1 + Platform.S22_H*q_P2H2*qd_P2H2 + Platform.S12_H*(q_P2H1*qd_P2H2 + q_P2H2*qd_P2H1));
XvP2_tip_2 = O1_H_tip*qd_P2H1 + O2_H_tip*qd_P2H2;
XvP2_tip_3 = O1_V_tip*qd_P2V1 + O2_V_tip*qd_P2V2;
XvP2_tip   = XvP2_tip_1*BP2(1,:) + XvP2_tip_2*BP2(2,:) + XvP2_tip_3*BP2(3,:);
EvP2_tip   = EvZ + XvP2_tip + cross(EwX, rP2_tip);

% --- 梁 3 (指向 240 度) ---
XvP3_1 = -(Platform.s11_V*q_P3V1*qd_P3V1 + Platform.s22_V*q_P3V2*qd_P3V2 + Platform.s12_V*(q_P3V1*qd_P3V2 + q_P3V2*qd_P3V1) ...
         + Platform.s11_H*q_P3H1*qd_P3H1 + Platform.s22_H*q_P3H2*qd_P3H2 + Platform.s12_H*(q_P3H1*qd_P3H2 + q_P3H2*qd_P3H1));
XvP3_2 = Platform.O1_H*qd_P3H1 + Platform.O2_H*qd_P3H2;
XvP3_3 = Platform.O1_V*qd_P3V1 + Platform.O2_V*qd_P3V2;
XvP3   = coprod(XvP3_1, BP3(1,:)) + coprod(XvP3_2, BP3(2,:)) + coprod(XvP3_3, BP3(3,:));
EvP3   = repmat(EvZ, 1, 1, Platform.nt) + XvP3 + cross(repmat(EwX, 1, 1, Platform.nt), rP3, 2);

XvP3_tip_1 = -(Platform.S11_V*q_P3V1*qd_P3V1 + Platform.S22_V*q_P3V2*qd_P3V2 + Platform.S12_V*(q_P3V1*qd_P3V2 + q_P3V2*qd_P3V1) ...
             + Platform.S11_H*q_P3H1*qd_P3H1 + Platform.S22_H*q_P3H2*qd_P3H2 + Platform.S12_H*(q_P3H1*qd_P3H2 + q_P3H2*qd_P3H1));
XvP3_tip_2 = O1_H_tip*qd_P3H1 + O2_H_tip*qd_P3H2;
XvP3_tip_3 = O1_V_tip*qd_P3V1 + O2_V_tip*qd_P3V2;
XvP3_tip   = XvP3_tip_1*BP3(1,:) + XvP3_tip_2*BP3(2,:) + XvP3_tip_3*BP3(3,:);
EvP3_tip   = EvZ + XvP3_tip + cross(EwX, rP3_tip);
...
% 平台基础转动偏导
EwP1_tip_R = EwX_R; EwP1_tip_P = EwX_P; EwP1_tip_Y = EwX_Y;
EwP2_tip_R = EwX_R; EwP2_tip_P = EwX_P; EwP2_tip_Y = EwX_Y;
EwP3_tip_R = EwX_R; EwP3_tip_P = EwX_P; EwP3_tip_Y = EwX_Y;

% 浮筒局部弯曲偏角速度
EwP1_tip_P1H1 =  Platform.dO1_H*BP1(3,:); EwP1_tip_P1H2 =  Platform.dO2_H*BP1(3,:);
EwP1_tip_P1V1 = -Platform.dO1_V*BP1(2,:); EwP1_tip_P1V2 = -Platform.dO2_V*BP1(2,:);

EwP2_tip_P2H1 =  Platform.dO1_H*BP2(3,:); EwP2_tip_P2H2 =  Platform.dO2_H*BP2(3,:);
EwP2_tip_P2V1 = -Platform.dO1_V*BP2(2,:); EwP2_tip_P2V2 = -Platform.dO2_V*BP2(2,:);

EwP3_tip_P3H1 =  Platform.dO1_H*BP3(3,:); EwP3_tip_P3H2 =  Platform.dO2_H*BP3(3,:);
EwP3_tip_P3V1 = -Platform.dO1_V*BP3(2,:); EwP3_tip_P3V2 = -Platform.dO2_V*BP3(2,:);
...
%% ================== OC4 浮筒偏线速度 ==================
% --- 梁 1 ---
EvP1_Sg = repmat(Z(1,:), 1, 1, Platform.nt);
EvP1_Sw = repmat(-Z(3,:), 1, 1, Platform.nt);
EvP1_Hv = repmat(Z(2,:), 1, 1, Platform.nt);
EvP1_R  = cross(repmat(EwX_R, 1, 1, Platform.nt), rP1, 2);
EvP1_P  = cross(repmat(EwX_P, 1, 1, Platform.nt), rP1, 2);
EvP1_Y  = cross(repmat(EwX_Y, 1, 1, Platform.nt), rP1, 2);

EvP1_P1H1 = coprod(-(Platform.s11_H*q_P1H1 + Platform.s12_H*q_P1H2), BP1(1,:)) + coprod(Platform.O1_H, BP1(2,:));
EvP1_P1H2 = coprod(-(Platform.s22_H*q_P1H2 + Platform.s12_H*q_P1H1), BP1(1,:)) + coprod(Platform.O2_H, BP1(2,:));
EvP1_P1V1 = coprod(-(Platform.s11_V*q_P1V1 + Platform.s12_V*q_P1V2), BP1(1,:)) + coprod(Platform.O1_V, BP1(3,:));
EvP1_P1V2 = coprod(-(Platform.s22_V*q_P1V2 + Platform.s12_V*q_P1V1), BP1(1,:)) + coprod(Platform.O2_V, BP1(3,:));

% 端部
EvP1_tip_Sg = Z(1,:); EvP1_tip_Sw = -Z(3,:); EvP1_tip_Hv = Z(2,:);
EvP1_tip_R = cross(EwX_R, rP1_tip); EvP1_tip_P = cross(EwX_P, rP1_tip); EvP1_tip_Y = cross(EwX_Y, rP1_tip);

EvP1_tip_P1H1 = -(Platform.S11_H*q_P1H1 + Platform.S12_H*q_P1H2)*BP1(1,:) + O1_H_tip*BP1(2,:);
EvP1_tip_P1H2 = -(Platform.S22_H*q_P1H2 + Platform.S12_H*q_P1H1)*BP1(1,:) + O2_H_tip*BP1(2,:);
EvP1_tip_P1V1 = -(Platform.S11_V*q_P1V1 + Platform.S12_V*q_P1V2)*BP1(1,:) + O1_V_tip*BP1(3,:);
EvP1_tip_P1V2 = -(Platform.S22_V*q_P1V2 + Platform.S12_V*q_P1V1)*BP1(1,:) + O2_V_tip*BP1(3,:);

% --- 梁 2 ---
EvP2_Sg = repmat(Z(1,:), 1, 1, Platform.nt);
EvP2_Sw = repmat(-Z(3,:), 1, 1, Platform.nt);
EvP2_Hv = repmat(Z(2,:), 1, 1, Platform.nt);
EvP2_R  = cross(repmat(EwX_R, 1, 1, Platform.nt), rP2, 2);
EvP2_P  = cross(repmat(EwX_P, 1, 1, Platform.nt), rP2, 2);
EvP2_Y  = cross(repmat(EwX_Y, 1, 1, Platform.nt), rP2, 2);

EvP2_P2H1 = coprod(-(Platform.s11_H*q_P2H1 + Platform.s12_H*q_P2H2), BP2(1,:)) + coprod(Platform.O1_H, BP2(2,:));
EvP2_P2H2 = coprod(-(Platform.s22_H*q_P2H2 + Platform.s12_H*q_P2H1), BP2(1,:)) + coprod(Platform.O2_H, BP2(2,:));
EvP2_P2V1 = coprod(-(Platform.s11_V*q_P2V1 + Platform.s12_V*q_P2V2), BP2(1,:)) + coprod(Platform.O1_V, BP2(3,:));
EvP2_P2V2 = coprod(-(Platform.s22_V*q_P2V2 + Platform.s12_V*q_P2V1), BP2(1,:)) + coprod(Platform.O2_V, BP2(3,:));

% 端部
EvP2_tip_Sg = Z(1,:); EvP2_tip_Sw = -Z(3,:); EvP2_tip_Hv = Z(2,:);
EvP2_tip_R = cross(EwX_R, rP2_tip); EvP2_tip_P = cross(EwX_P, rP2_tip); EvP2_tip_Y = cross(EwX_Y, rP2_tip);

EvP2_tip_P2H1 = -(Platform.S11_H*q_P2H1 + Platform.S12_H*q_P2H2)*BP2(1,:) + O1_H_tip*BP2(2,:);
EvP2_tip_P2H2 = -(Platform.S22_H*q_P2H2 + Platform.S12_H*q_P2H1)*BP2(1,:) + O2_H_tip*BP2(2,:);
EvP2_tip_P2V1 = -(Platform.S11_V*q_P2V1 + Platform.S12_V*q_P2V2)*BP2(1,:) + O1_V_tip*BP2(3,:);
EvP2_tip_P2V2 = -(Platform.S22_V*q_P2V2 + Platform.S12_V*q_P2V1)*BP2(1,:) + O2_V_tip*BP2(3,:);

% --- 梁 3 ---
EvP3_Sg = repmat(Z(1,:), 1, 1, Platform.nt);
EvP3_Sw = repmat(-Z(3,:), 1, 1, Platform.nt);
EvP3_Hv = repmat(Z(2,:), 1, 1, Platform.nt);
EvP3_R  = cross(repmat(EwX_R, 1, 1, Platform.nt), rP3, 2);
EvP3_P  = cross(repmat(EwX_P, 1, 1, Platform.nt), rP3, 2);
EvP3_Y  = cross(repmat(EwX_Y, 1, 1, Platform.nt), rP3, 2);

EvP3_P3H1 = coprod(-(Platform.s11_H*q_P3H1 + Platform.s12_H*q_P3H2), BP3(1,:)) + coprod(Platform.O1_H, BP3(2,:));
EvP3_P3H2 = coprod(-(Platform.s22_H*q_P3H2 + Platform.s12_H*q_P3H1), BP3(1,:)) + coprod(Platform.O2_H, BP3(2,:));
EvP3_P3V1 = coprod(-(Platform.s11_V*q_P3V1 + Platform.s12_V*q_P3V2), BP3(1,:)) + coprod(Platform.O1_V, BP3(3,:));
EvP3_P3V2 = coprod(-(Platform.s22_V*q_P3V2 + Platform.s12_V*q_P3V1), BP3(1,:)) + coprod(Platform.O2_V, BP3(3,:));

% 端部
EvP3_tip_Sg = Z(1,:); EvP3_tip_Sw = -Z(3,:); EvP3_tip_Hv = Z(2,:);
EvP3_tip_R = cross(EwX_R, rP3_tip); EvP3_tip_P = cross(EwX_P, rP3_tip); EvP3_tip_Y = cross(EwX_Y, rP3_tip);

EvP3_tip_P3H1 = -(Platform.S11_H*q_P3H1 + Platform.S12_H*q_P3H2)*BP3(1,:) + O1_H_tip*BP3(2,:);
EvP3_tip_P3H2 = -(Platform.S22_H*q_P3H2 + Platform.S12_H*q_P3H1)*BP3(1,:) + O2_H_tip*BP3(2,:);
EvP3_tip_P3V1 = -(Platform.S11_V*q_P3V1 + Platform.S12_V*q_P3V2)*BP3(1,:) + O1_V_tip*BP3(3,:);
EvP3_tip_P3V2 = -(Platform.S22_V*q_P3V2 + Platform.S12_V*q_P3V1)*BP3(1,:) + O2_V_tip*BP3(3,:);
...
dXvP1_1 = -(Platform.s11_V*qd_P1V1^2 + Platform.s22_V*qd_P1V2^2 + 2*Platform.s12_V*qd_P1V1*qd_P1V2 ...
          + Platform.s11_H*qd_P1H1^2 + Platform.s22_H*qd_P1H2^2 + 2*Platform.s12_H*qd_P1H1*qd_P1H2);
dXvP1 = coprod(dXvP1_1, BP1(1,:)); % 弯曲向(Y,Z)均为线性，二阶导无速度项
dEvP1 = repmat(dEvZ, 1, 1, Platform.nt) + dXvP1 + cross(repmat(dEwX, 1, 1, Platform.nt), rP1, 2) ...
      + cross(repmat(EwX, 1, 1, Platform.nt), cross(repmat(EwX, 1, 1, Platform.nt), rP1, 2), 2) ...
      + 2*cross(repmat(EwX, 1, 1, Platform.nt), XvP1, 2);

dXvP1_tip_1 = -(Platform.S11_V*qd_P1V1^2 + Platform.S22_V*qd_P1V2^2 + 2*Platform.S12_V*qd_P1V1*qd_P1V2 ...
              + Platform.S11_H*qd_P1H1^2 + Platform.S22_H*qd_P1H2^2 + 2*Platform.S12_H*qd_P1H1*qd_P1H2);
dEvP1_tip = dEvZ + dXvP1_tip_1*BP1(1,:) + cross(dEwX, rP1_tip) + cross(EwX, cross(EwX, rP1_tip)) + 2*cross(EwX, XvP1_tip);

dEw_rel1_tip = -(Platform.dO1_V*qd_P1V1 + Platform.dO2_V*qd_P1V2)*BP1(2,:) + (Platform.dO1_H*qd_P1H1 + Platform.dO2_H*qd_P1H2)*BP1(3,:);
dEwP1_tip = dEwX + cross(EwX, dEw_rel1_tip);

% --- 梁 2 ---
dXvP2_1 = -(Platform.s11_V*qd_P2V1^2 + Platform.s22_V*qd_P2V2^2 + 2*Platform.s12_V*qd_P2V1*qd_P2V2 ...
          + Platform.s11_H*qd_P2H1^2 + Platform.s22_H*qd_P2H2^2 + 2*Platform.s12_H*qd_P2H1*qd_P2H2);
dXvP2 = coprod(dXvP2_1, BP2(1,:));
dEvP2 = repmat(dEvZ, 1, 1, Platform.nt) + dXvP2 + cross(repmat(dEwX, 1, 1, Platform.nt), rP2, 2) ...
      + cross(repmat(EwX, 1, 1, Platform.nt), cross(repmat(EwX, 1, 1, Platform.nt), rP2, 2), 2) ...
      + 2*cross(repmat(EwX, 1, 1, Platform.nt), XvP2, 2);

dXvP2_tip_1 = -(Platform.S11_V*qd_P2V1^2 + Platform.S22_V*qd_P2V2^2 + 2*Platform.S12_V*qd_P2V1*qd_P2V2 ...
              + Platform.S11_H*qd_P2H1^2 + Platform.S22_H*qd_P2H2^2 + 2*Platform.S12_H*qd_P2H1*qd_P2H2);
dEvP2_tip = dEvZ + dXvP2_tip_1*BP2(1,:) + cross(dEwX, rP2_tip) + cross(EwX, cross(EwX, rP2_tip)) + 2*cross(EwX, XvP2_tip);

dEw_rel2_tip = -(Platform.dO1_V*qd_P2V1 + Platform.dO2_V*qd_P2V2)*BP2(2,:) + (Platform.dO1_H*qd_P2H1 + Platform.dO2_H*qd_P2H2)*BP2(3,:);
dEwP2_tip = dEwX + cross(EwX, dEw_rel2_tip);

% --- 梁 3 ---
dXvP3_1 = -(Platform.s11_V*qd_P3V1^2 + Platform.s22_V*qd_P3V2^2 + 2*Platform.s12_V*qd_P3V1*qd_P3V2 ...
          + Platform.s11_H*qd_P3H1^2 + Platform.s22_H*qd_P3H2^2 + 2*Platform.s12_H*qd_P3H1*qd_P3H2);
dXvP3 = coprod(dXvP3_1, BP3(1,:));
dEvP3 = repmat(dEvZ, 1, 1, Platform.nt) + dXvP3 + cross(repmat(dEwX, 1, 1, Platform.nt), rP3, 2) ...
      + cross(repmat(EwX, 1, 1, Platform.nt), cross(repmat(EwX, 1, 1, Platform.nt), rP3, 2), 2) ...
      + 2*cross(repmat(EwX, 1, 1, Platform.nt), XvP3, 2);

dXvP3_tip_1 = -(Platform.S11_V*qd_P3V1^2 + Platform.S22_V*qd_P3V2^2 + 2*Platform.S12_V*qd_P3V1*qd_P3V2 ...
              + Platform.S11_H*qd_P3H1^2 + Platform.S22_H*qd_P3H2^2 + 2*Platform.S12_H*qd_P3H1*qd_P3H2);
dEvP3_tip = dEvZ + dXvP3_tip_1*BP3(1,:) + cross(dEwX, rP3_tip) + cross(EwX, cross(EwX, rP3_tip)) + 2*cross(EwX, XvP3_tip);

dEw_rel3_tip = -(Platform.dO1_V*qd_P3V1 + Platform.dO2_V*qd_P3V2)*BP3(2,:) + (Platform.dO1_H*qd_P3H1 + Platform.dO2_H*qd_P3H2)*BP3(3,:);
dEwP3_tip = dEwX + cross(EwX, dEw_rel3_tip);
...
idx_P1 = 23:26; idx_P2 = 27:30; idx_P3 = 31:34;
f_Plat(23) = -Platform.K11_H*q_P1H1 - 2*Platform.zeta1_H*sqrt(Platform.K11_H*Platform.M11_H_tot)*qd_P1H1;
f_Plat(24) = -Platform.K22_H*q_P1H2 - 2*Platform.zeta2_H*sqrt(Platform.K22_H*Platform.M22_H_tot)*qd_P1H2;
f_Plat(25) = -Platform.K11_V*q_P1V1 - 2*Platform.zeta1_V*sqrt(Platform.K11_V*Platform.M11_V_tot)*qd_P1V1;
f_Plat(26) = -Platform.K22_V*q_P1V2 - 2*Platform.zeta2_V*sqrt(Platform.K22_V*Platform.M22_V_tot)*qd_P1V2;
f_Plat(27) = -Platform.K11_H*q_P2H1 - 2*Platform.zeta1_H*sqrt(Platform.K11_H*Platform.M11_H_tot)*qd_P2H1;
f_Plat(28) = -Platform.K22_H*q_P2H2 - 2*Platform.zeta2_H*sqrt(Platform.K22_H*Platform.M22_H_tot)*qd_P2H2;
f_Plat(29) = -Platform.K11_V*q_P2V1 - 2*Platform.zeta1_V*sqrt(Platform.K11_V*Platform.M11_V_tot)*qd_P2V1;
f_Plat(30) = -Platform.K22_V*q_P2V2 - 2*Platform.zeta2_V*sqrt(Platform.K22_V*Platform.M22_V_tot)*qd_P2V2;
f_Plat(31) = -Platform.K11_H*q_P3H1 - 2*Platform.zeta1_H*sqrt(Platform.K11_H*Platform.M11_H_tot)*qd_P3H1;
f_Plat(32) = -Platform.K22_H*q_P3H2 - 2*Platform.zeta2_H*sqrt(Platform.K22_H*Platform.M22_H_tot)*qd_P3H2;
f_Plat(33) = -Platform.K11_V*q_P3V1 - 2*Platform.zeta1_V*sqrt(Platform.K11_V*Platform.M11_V_tot)*qd_P3V1;
f_Plat(34) = -Platform.K22_V*q_P3V2 - 2*Platform.zeta2_V*sqrt(Platform.K22_V*Platform.M22_V_tot)*qd_P3V2;

% 为三个浮筒打包对应的偏速度和索引，进行极化积分
P_Ev_all     = {cat(1, EvP1_Sg, EvP1_Sw, EvP1_Hv, EvP1_R, EvP1_P, EvP1_Y, EvP1_P1H1, EvP1_P1H2, EvP1_P1V1, EvP1_P1V2), ...
                cat(1, EvP2_Sg, EvP2_Sw, EvP2_Hv, EvP2_R, EvP2_P, EvP2_Y, EvP2_P2H1, EvP2_P2H2, EvP2_P2V1, EvP2_P2V2), ...
                cat(1, EvP3_Sg, EvP3_Sw, EvP3_Hv, EvP3_R, EvP3_P, EvP3_Y, EvP3_P3H1, EvP3_P3H2, EvP3_P3V1, EvP3_P3V2)};
P_Ev_tip_all = {[EvP1_tip_Sg; EvP1_tip_Sw; EvP1_tip_Hv; EvP1_tip_R; EvP1_tip_P; EvP1_tip_Y; EvP1_tip_P1H1; EvP1_tip_P1H2; EvP1_tip_P1V1; EvP1_tip_P1V2], ...
                [EvP2_tip_Sg; EvP2_tip_Sw; EvP2_tip_Hv; EvP2_tip_R; EvP2_tip_P; EvP2_tip_Y; EvP2_tip_P2H1; EvP2_tip_P2H2; EvP2_tip_P2V1; EvP2_tip_P2V2], ...
                [EvP3_tip_Sg; EvP3_tip_Sw; EvP3_tip_Hv; EvP3_tip_R; EvP3_tip_P; EvP3_tip_Y; EvP3_tip_P3H1; EvP3_tip_P3H2; EvP3_tip_P3V1; EvP3_tip_P3V2]};
P_Ew_tip_all = {[EwP1_tip_R; EwP1_tip_P; EwP1_tip_Y; EwP1_tip_P1H1; EwP1_tip_P1H2; EwP1_tip_P1V1; EwP1_tip_P1V2], ...
                [EwP2_tip_R; EwP2_tip_P; EwP2_tip_Y; EwP2_tip_P2H1; EwP2_tip_P2H2; EwP2_tip_P2V1; EwP2_tip_P2V2], ...
                [EwP3_tip_R; EwP3_tip_P; EwP3_tip_Y; EwP3_tip_P3H1; EwP3_tip_P3H2; EwP3_tip_P3V1; EwP3_tip_P3V2]};
P_dEv        = {dEvP1, dEvP2, dEvP3};
P_dEv_tip    = {dEvP1_tip, dEvP2_tip, dEvP3_tip};
P_dEw_tip    = {dEwP1_tip, dEwP2_tip, dEwP3_tip};
P_Ew_tip     = {EwP1_tip, EwP2_tip, EwP3_tip};
P_BP         = {BP1, BP2, BP3};
P_idx        = {[1:6, idx_P1], [1:6, idx_P2], [1:6, idx_P3]};
P_idx_rot    = {[4:6, idx_P1], [4:6, idx_P2], [4:6, idx_P3]};

% --- 补充全局海水密度变量 ---
global FLUIDDENSITY;
if isempty(FLUIDDENSITY)
    FLUIDDENSITY = 1025; % 标准海水密度 [kg/m^3]
end
% dm_X = Platform.dm_V - FLUIDDENSITY*pi*(1.6/2)^2; % 仅保留结构线质量 (轴向不计算附加质量)

% 提取真实结构质量，用于计算纯重力（去除附加质量）
dm_struct = Platform.dm_H - FLUIDDENSITY*pi*(1.6/2)^2; % 梁结构线质量
M_tip_struct = Platform.TipMass_H - FLUIDDENSITY * 0.63 * (pi*(24/2)^2*6 + pi*(12/2)^2*26); % 端部结构质量
...
for k = 1:3
    ...
    for i = 1:length(idx_rot)
        ...
        for j = 1:length(idx_rot)
            c = idx_rot(j);
            w_c_tip = P_Ew_tip_all{k}(j,:);
            C_Plat(r,c) = C_Plat(r,c) + dot(w_r_tip, (Platform.TipInertia * w_c_tip')');
        end
    end
end
...
%% Assembly
IM_nom  = C_com + C_B1 + C_B2 + C_B3 + C_T + C_Plat;
IM_nom(1:6,1:6) = IM_nom(1:6,1:6) + Platform.AM;

f_nom = f_com + f_B1 + f_B2 + f_B3 +...
    f_ElasticB1 + f_DampingB1 +...
    f_ElasticB2 + f_DampingB2 +...
    f_ElasticB3 + f_DampingB3 +...
    f_T + f_ElasticT + f_DampingT +...
    f_Yaw  + f_Gen + f_Brake +...
