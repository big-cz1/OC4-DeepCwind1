function [ OopDefl1, IPDefl1, TipDzb1, TTDspFA, TTDspSS, LSSTipV, NacYaw, TwrClrnB1, TwrClrnB2, TwrClrnB3, BldTwrHrClr, Surge, Sway, Heave, Roll, Pitch, Yaw, q_Platform, q_All] = Results( t,q, Controls, DOFs, ElastoDyn, Twr, Bld )
...
%% Generate results
% 2. 在进入时间循环前，预分配我们新增的输出矩阵
q_Platform = zeros(length(t), 12);
q_All      = zeros(length(t), 34);
for i = 1:length(t)
    ...
    q_Platform(i, :) = [q_P1H1, q_P1H2, q_P1V1, q_P1V2, q_P2H1, q_P2H2, q_P2V1, q_P2V2, q_P3H1, q_P3H2, q_P3V1, q_P3V2];
    q_All(i, :) = Comq(1:34)';
    %% Coordinate Systems
